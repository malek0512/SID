...
evaluate_model <- function (df = NULL, model = perceptron_learn, model_test = model_test) {
  # constantes
...
evaluate_model(df = getDataBase(database = "breast.cancer"), model = perceptron_learn, model_test = model_test)
